        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Relationships_Classes_FK_ClassId",
                        column: x => x.FK_ClassId,
                        principalTable: "Classes",
                        principalColumn: "ClassId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Relationships_Courses_FK_CourseId",
                        column: x => x.FK_CourseId,
                        principalTable: "Courses",
                        principalColumn: "CourseId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Relationships_Students_FK_StudentId",
                        column: x => x.FK_StudentId,
                        principalTable: "Students",
                        principalColumn: "StudentId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Relationships_Teachers_FK_TeacherId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Relationships_FK_ClassId",
                table: "Relationships",
                column: "FK_ClassId");

            migrationBuilder.CreateIndex(
                name: "IX_Relationships_FK_CourseId",
                table: "Relationships",
                column: "FK_CourseId");

            migrationBuilder.CreateIndex(
                name: "IX_Relationships_FK_StudentId",
                table: "Relationships",
                column: "FK_StudentId");

            migrationBuilder.CreateIndex(
                name: "IX_Relationships_FK_TeacherId",
                table: "Relationships",
                column: "FK_TeacherId");
        }
